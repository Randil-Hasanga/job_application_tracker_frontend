...
function AddApplication() {
    ...
    return (
        <div className="h-screen overflow-auto bg-gray-50 px-4 sm:px-8 py-4 sm:py-6" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            <div className="bg-white rounded-xl sm:rounded-3xl border border-blue-400 shadow px-4 py-4 sm:px-8 sm:py-6 max-w-4xl mx-auto">
                <h2 className="text-2xl sm:text-3xl font-semibold text-gray-800 mb-2 text-center sm:text-right">
                    Add Job Application
                </h2>

                <form onSubmit={handleSubmit} className="space-y-4">
                    {/* AI Section */}
                    <div className="rounded-xl sm:rounded-3xl mb-4 sm:mb-6">
                        <label className="block font-medium text-black mb-2">
                            You can use AI to extract information!
                        </label>
                        <div className="relative">
                            <textarea
                                ...
                                rows={3}
                                className="w-full border border-gray-300 px-4 py-2 rounded-xl sm:rounded-3xl focus:ring-2 focus:ring-blue-500 focus:outline-none"
                            />
                            <button
                                type="button"
                    ...
                    <div className="space-y-4">
                        <div className="rounded-xl sm:rounded-3xl">
                        ...
                        <div className="flex flex-col sm:flex-row sm:space-x-6 space-y-4 sm:space-y-0 rounded-xl sm:rounded-3xl">
                            ...
                            <div className="flex-1 rounded-xl sm:rounded-3xl">
                                <label className="block font-bold text-gray-700 mb-1">Status</label>
                                <select
                                    name="status"
                                    value={formData.status}
                                    onChange={handleChange}
                                    className={`w-full border border-gray-300 px-4 py-2 rounded-xl sm:rounded-3xl focus:ring-2 focus:ring-blue-500 focus:outline-none ${formData.status ? statusColors[formData.status] : ''
                                        }`}
                                >
                    ...
                    {/* Form Buttons */}
                    <div className="flex flex-col-reverse sm:flex-row justify-end space-y-4 space-y-reverse sm:space-y-0 sm:space-x-4 rounded-xl sm:rounded-3xl">
                        <button
                            type="button"
                            onClick={handleCancel}
                            className="px-4 py-2 sm:px-6 sm:py-2 rounded-xl sm:rounded-3xl border border-gray-300 text-gray-700 hover:bg-gray-100 transition"
                        >
                            Cancel
                        </button>
                        <button
                            type="submit"
                            className={`bg-blue-600 border border-white text-white px-4 py-2 rounded-xl sm:rounded-3xl hover:bg-white hover:text-black hover:border-black shadow-lg flex items-center justify-center gap-2 ${submitLoading ? 'opacity-70 cursor-not-allowed' : ''
                                }`}
