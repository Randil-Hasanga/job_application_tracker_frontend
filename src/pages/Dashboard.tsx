        ...
        <div className="rounded-xl h-screen overflow-auto bg-gray-50 px-4    sm:px-8" style={{ fontFamily: 'Inter, sans-serif' }}>
            ...
            {filteredApps.length === 0 ? (
                ...
                <>
                    ...
                    {/* Status Filter - Full width on mobile, exact original width on desktop */}
                        ...
                        {/* Search Input - Full width on mobile, exact original flex behavior on desktop */}
                        <input
                            type="text"
                        ...
                        {/* Add Button - Full width on mobile, exact original size on desktop */}
                        <button
